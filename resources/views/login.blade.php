...
<body>
    ...
    <div class="container">
      <form action="{{route('login.proses')}}" method="POST" data-aos="zoom-in-right" data-aos-delay="290" data-aos-easing="ease-in-out" class="form_container">
        @csrf
        <div class="title_container">
          <p class="title">Login lah terlebih dahulu</p>
          @if (Session::get('failed'))
                  <div class="alert alert-danger">{{ Session::get('failed')}}</div>
              @endif
            <span class="subtitle">Masukan email dan password dengan benar supaya bisa masuk</span>
        </div>
        <br>
        <div class="input_container">
          ...
          <input placeholder="nama123@gmail.com" name="email" type="text" class="input_field">
        </div>
        @error('email')
      ...
      @enderror
        <div class="input_container">
          ...
          <input placeholder="password" name="password" type="password" class="input_field">
      ...
      <button title="Sign In" type="submit" class="sign-in_btn">
        ...
        <div data-aos="zoom-in-left" data-aos-delay="290" data-aos-easing="ease-in-out" class="img" >
